...
const formSetDefaults = new Set([
  'deoxys-normal', 'burmy', 'wormadam-plant', 'shellos-west', 'gastrodon-west', 'rotom', 'giratina-altered', 'shaymin-land',
  'basculin-red-striped', 'deerling-spring', 'sawsbuck-spring', 'tornadus-incarnate', 'thundurus-incarnate',
  'landorus-incarnate', 'keldeo-ordinary', 'meloetta-aria', 'flabebe-red', 'floette-red', 'florges-red',
  'furfrou-natural', 'pumpkaboo-average', 'gourgeist-average', 'oricorio-baile', 'lycanroc-midday',
  'wishiwashi-solo', 'minior-red-meteor', 'necrozma', 'toxtricity-amped', 'sinistea', 'polteageist',
  'urshifu-single-strike', 'enamorus-incarnate', 'palafin-zero', 'maushold-family-of-four',
...
const formOrder = ['Hoenn Forms', 'Sinnoh Forms', 'Unova Forms', 'Kalos Forms', 'Kalos Forms II', 'Alola Forms', 'Alola Forms II', 'Galar Forms', 'Hisui Forms', 'Paldea Forms'];
...
const formIds = new Map([['Hoenn Forms','forms-3'],['Sinnoh Forms','forms-4'],['Unova Forms','forms-5'],['Kalos Forms','forms-6'],['Alola Forms','forms-7'],['Galar Forms','forms-8'],['Hisui Forms','forms-9'],['Paldea Forms','forms-10'],['Kalos Forms II','forms-11'],['Alola Forms II','forms-12']]);
